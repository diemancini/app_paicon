...
export var ListaEmpresasPage = (function () {
    function ListaEmpresasPage(navCtrl, navParams) {
    ...
    ListaEmpresasPage.prototype.editarDadosEmpresa = function (event, item) {
    ...
    ListaEmpresasPage.prototype.cadastrarEmpresa = function (event) {
        var empresa = {
            nome: "",
            cnpj: "",
            razao_social: "",
    ...
    /** @nocollapse */
    ListaEmpresasPage.ctorParameters = [
        { type: NavController, },
        { type: NavParams, },
    ];
    return ListaEmpresasPage;
}());
//# sourceMappingURL=lista-empresas.js.map